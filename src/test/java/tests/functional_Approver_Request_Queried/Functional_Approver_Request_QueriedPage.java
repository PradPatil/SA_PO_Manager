package tests.functional_Approver_Request_Queried;
...
import pageObjects.functional_Approver_Request_QueriedObjects.Functional_Approver_Request_QueriedObject;
import tests.login.LoginPage;

public class Functional_Approver_Request_QueriedPage {
	...
	public void FunctionalApprovalQueriedRequest(String username,String password) throws IOException, InterruptedException
	{
		LoginPage obj = new LoginPage();
		obj.validateLogin(username,password);
		driver = obj.driver;
		Functional_Approver_Request_QueriedObject obj1 = new Functional_Approver_Request_QueriedObject(driver);
