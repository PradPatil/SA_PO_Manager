package tests.functionalApprover_RequestApprovals;
...
import pageObjects.functionalApprover_RequestApprovalObjects.FunctionalApprover_RequestApprovalObject;
import tests.login.LoginPage;

public class Functional_Approver_Request_ApprovalPage {
	...
	public void functionalapproval(String username,String password) throws IOException, InterruptedException
	{
		...
		driver = obj.driver;
		FunctionalApprover_RequestApprovalObject obj1 = new FunctionalApprover_RequestApprovalObject(driver);
