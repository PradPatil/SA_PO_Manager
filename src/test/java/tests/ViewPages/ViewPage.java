...
import pageObjects.ViewPageObjects.ViewPageObject;
...
public class ViewPage {
	...
	public ViewPageObject ViewObj;

	@Test (dataProvider="getdata")
	public void ViewRequests(String username,String password) throws IOException, InterruptedException
	{
		LoginPage obj = new LoginPage();
		obj.validateLogin(username,password);
		driver = obj.driver;
		ViewObj = new ViewPageObject(driver);
		Thread.sleep(1000);
