package tests.functional_Approver_Approval;
...
import pageObjects.functional_Approver_ApproveObjects.Functional_Approver_ApprovedObject;
import tests.login.LoginPage;

public class Functional_Approver_ApprovalPage {
	...
	public void FunctionalApprove(String username,String password) throws IOException, InterruptedException
	{
		...
		driver = obj.driver;
		ITReqObj = new Functional_Approver_ApprovedObject(driver);
		Thread.sleep(1000);
