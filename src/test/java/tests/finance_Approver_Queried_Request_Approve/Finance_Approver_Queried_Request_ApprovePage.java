package tests.finance_Approver_Queried_Request_Approve;
...
import pageObjects.finance_Approver_QueriedRequest_ApproveObjects.Finance_Approver_QueriedRequest_ApproveObject;
import tests.login.LoginPage;

public class Finance_Approver_Queried_Request_ApprovePage {

	public JavascriptExecutor js;
	public WebDriver driver;
	public String requestIDtext ="";
	Finance_Approver_QueriedRequest_ApproveObject obj1;
	
	@Test (dataProvider="getdata")
	public void FinanceApprovalQueryApprove(String username,String password) throws IOException, InterruptedException
	{
		LoginPage obj = new LoginPage();
		obj.validateLogin(username,password);
		driver = obj.driver;
		obj1 = new Finance_Approver_QueriedRequest_ApproveObject(driver);
