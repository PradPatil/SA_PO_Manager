package tests.functional_Approver_View_Request;
...
import pageObjects.functional_Approver_View_RequestObjects.Functional_Approver_View_RequestObject;
import tests.login.LoginPage;

public class Functional_Approver_View_RequestPage {
	...
	public void FuntionalApproverViewRequest(String username,String password) throws IOException, InterruptedException
	{
		...
		driver = obj.driver;
		ViewObj = new Functional_Approver_View_RequestObject(driver);
		Thread.sleep(1000);
