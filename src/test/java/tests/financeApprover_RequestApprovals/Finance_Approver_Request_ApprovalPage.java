package tests.financeApprover_RequestApprovals;
...
import pageObjects.financeApprover_RequestApprovalObjects.Finance_Approver_Request_ApprovalObject;
import tests.login.LoginPage;

public class Finance_Approver_Request_ApprovalPage {
	...
	public void financeapproval(String username,String password) throws IOException, InterruptedException
	{
		...
		driver = obj.driver;
		Finance_Approver_Request_ApprovalObject obj1 = new Finance_Approver_Request_ApprovalObject(driver);
