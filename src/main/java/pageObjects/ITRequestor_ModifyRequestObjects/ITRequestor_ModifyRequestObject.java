package pageObjects.ITRequestor_ModifyRequestObjects;
...
public class ITRequestor_ModifyRequestObject {

	public WebDriver driver;

	public ITRequestor_ModifyRequestObject(WebDriver driver) {
		this.driver = driver;
	}

	By ITRequestmenu = By.xpath("//*[@id='ul-menus']/li[2]");
	By ViewRequestmenu = By.xpath("//*[@id='ul-menus']/li[2]/ul/li[3]/a");
	By actionbutton = By.xpath("//*[@id=\"tblActive\"]/tbody/tr[last()]/td[9]/a/span");
	...
	public void getscrolltolastcolumn() {
		WebElement lastrowcolumn = driver.findElement(By.xpath("(//*[@id='tblActive']/tbody/tr)[last()]/td[12]/i"));
	...
	public void getqueryresponsedropdownaction() {
		...
		approvalaction.selectByVisibleText("Query responded to Functional Approver");
	}

	public void getqueryremark() {
		driver.findElement(Remark).sendKeys("Query responded to Functional Approver");
