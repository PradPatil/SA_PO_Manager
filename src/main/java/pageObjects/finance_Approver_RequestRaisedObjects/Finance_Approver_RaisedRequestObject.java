package pageObjects.finance_Approver_RequestRaisedObjects;
...
public class Finance_Approver_RaisedRequestObject {
	
	public WebDriver driver;

	public Finance_Approver_RaisedRequestObject(WebDriver driver) {
		this.driver = driver;
	}
