package pageObjects.finance_Approver_QueriedRequest_ApproveObjects;
...
public class Finance_Approver_QueriedRequest_ApproveObject {
	
	public WebDriver driver;

	public Finance_Approver_QueriedRequest_ApproveObject(WebDriver driver) {
		this.driver = driver;		
	}
	...
	public void getlastrowscroll() {
		...
		public void getfinanceapprovaldropdownaction() {
			...
			approvalaction.selectByVisibleText("Approved by Finance Approver");
		}
		
		public void getfinanceremark() {
	        driver.findElement(financeapproverremark).sendKeys("Request Approved by Finance Approver");
