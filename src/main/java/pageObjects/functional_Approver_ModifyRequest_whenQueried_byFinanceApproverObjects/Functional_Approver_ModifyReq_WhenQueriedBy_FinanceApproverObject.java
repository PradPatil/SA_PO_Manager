package pageObjects.functional_Approver_ModifyRequest_whenQueried_byFinanceApproverObjects;
...
public class Functional_Approver_ModifyReq_WhenQueriedBy_FinanceApproverObject {

	public WebDriver driver;

	public Functional_Approver_ModifyReq_WhenQueriedBy_FinanceApproverObject(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void getfunapprovaldropdownaction() {
		...
		approvalaction.selectByVisibleText("Query Responded to Finance");
	}

	public void getfunctionalremark() {
		driver.findElement(functionalapproverremark).sendKeys("Query Responded to Finance Approver");
