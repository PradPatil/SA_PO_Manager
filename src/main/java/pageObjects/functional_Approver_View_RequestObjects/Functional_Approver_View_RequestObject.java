package pageObjects.functional_Approver_View_RequestObjects;
...
public class Functional_Approver_View_RequestObject {
	public WebDriver driver;

	public Functional_Approver_View_RequestObject(WebDriver driver) {
		this.driver = driver;
	}
