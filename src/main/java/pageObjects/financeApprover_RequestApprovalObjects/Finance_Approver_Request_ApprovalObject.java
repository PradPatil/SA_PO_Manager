package pageObjects.financeApprover_RequestApprovalObjects;
...
public class Finance_Approver_Request_ApprovalObject {

	public WebDriver driver;

	public Finance_Approver_Request_ApprovalObject(WebDriver driver) {
		this.driver = driver;
	}
