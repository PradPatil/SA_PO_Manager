package pageObjects.finance_View_RequestObjects;
...
public class Finance_Approver_View_RequestObject {
	public WebDriver driver;

	public Finance_Approver_View_RequestObject(WebDriver driver) {
		this.driver = driver;
	}
