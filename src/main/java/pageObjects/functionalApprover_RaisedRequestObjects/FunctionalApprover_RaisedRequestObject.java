package pageObjects.functionalApprover_RaisedRequestObjects;
...
public class FunctionalApprover_RaisedRequestObject {

	public WebDriver driver;

	public FunctionalApprover_RaisedRequestObject(WebDriver driver) {
		this.driver = driver;
	}

	By ITRequestmenu = By.xpath("//*[@id='ul-menus']/li[2]");
	By newrequest = By.xpath("//*[@id=\"ul-menus\"]/li[2]/ul/li[1]/a");
	...
	By Actionbutton = By.xpath("//*[@id='tblActive']/tbody/tr[last()]/td[9]/a/i");
